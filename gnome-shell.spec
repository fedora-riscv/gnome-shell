...
Patch3: 0001-st-Fix-offscreen-leak-if-cogl_framebuffer_allocate-f.patch
...
%patch3 -p1 -b .fix-offscreen-memory-leak
...
%changelog
* Thu Apr 21 2016 Florian Müllner <fmuellner@redhat.com> - 3.16.4-2
- Backport memory leak fix

* Thu Oct 15 2015 Florian Müllner <fmuellner@redhat.com> - 3.16.4-1
- Update to 3.16.4
