...
Source0:        http://download.gnome.org/sources/gnome-shell/3.18/%{name}-%{version}.tar.xz
...
* Thu Mar 03 2016 Florian Müllner <fmuellner@redhat.com> - 3.18.4-1
- Update to 3.18.4

* Tue Nov 17 2015 Florian Müllner <fmuellner@redhat.com> - 3.18.3-1
- Update to 3.18.3

* Mon Nov 16 2015 Kalev Lember <klember@redhat.com> - 3.18.2-2
- Revert a change that caused the browser plugin to crash under Firefox
  (#1282373)
